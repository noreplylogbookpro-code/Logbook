  ...
  return (
    ...
    >
      ...
      <main className="flex-grow">
        ...
        {view === 'master' && <MasterView onNavigate={navigate} />}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <a href="#"
                className="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 hover:text-accent-blue hover:border-accent-blue/30"
                style={{ border: '1px solid var(--border)', background: 'var(--bg-input)', color: 'var(--text-muted)' }}
              >
              ...
              <a href="#"
                className="w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 hover:text-accent-cyan hover:border-accent-cyan/30"
                style={{ border: '1px solid var(--border)', background: 'var(--bg-input)', color: 'var(--text-muted)' }}
              >
